        ...
        <Route path="/" element={<AppLayout />}>
          ...
          <Route element={<MainContentLayout />}>
            ...
            <Route path="team-members">
              ...
              <Route
                path="dev-co"
                element={<TeamMembers department="Dév. Commercial" />}
              />
              <Route
                path="marketing"
                element={<TeamMembers department="Marketing" />}
              />
              <Route
                path="projet"
                element={<TeamMembers department="Projet" />}
              />
              <Route
                path="cellule-qualite"
                element={<TeamMembers department="Cellule Qualité" />}
              />
            </Route>
